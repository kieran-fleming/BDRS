...
<!-- @file This file contains the micro templates that tmpl (javascript templating) use in the offline app. These are currently 
referenced from home.jsp -->
...
<script id="inputLabelTmpl" type="text/html">
...
<div class="record_list_item" id="record{{=recordid}}">
	...
	<a href="#/record/?action=edit&rid={{=recordid}}&sid={{=surveyId}}">
...
<form id="featForm">
	<div id="transpBox">
		...
		<div style="text-align: center; clear: left; margin-top: 10px;">
			<input type="button" class="form_action" value="Clear Options" id="idToolFormReset" onclick="this.form.reset();"/>
...
<div style="float: left; text-align: center; padding: 2px; ">
	<img src="/BDRS/{{=value}}" alt="{{=value}}" class="sillImg"/><br/>
...
<script id="boxImageTmpl" type="text/html">
<div id="boxImage" class="listItem box">
	<div class="boxImageTitle box">{{=header}}</div>
	<img src="{{=src}}" alt="{{=alt}}" class="box"/>
	<div id="thumbNails">{{=thumbImages}}</div>
</div>
<div style="clear:both;"></div>
</script>

<script id="thumbImageTmpl" type="text/html">
	<img src="{{=src}}" id="{{=id}}" alt="{{=alt}}" class="box"/>
</script>

<script id="listSlideItemTmpl" type="text/html">
<div>{{=header}}</div>
<div>{{=content}}</div>
<div style="clear:both;"></div>
</script>
...
<div class="listMenuItem">
	<a href="{{=url}}" onclick="{{=func}}">
		<img class="listMenuItemIcon" src="{{=iconUrl}}" alt="{{=alt}}">
		<br>
...
<script id="listInfoItemTmpl" type="text/html">
<div id="{{=id}}" class="listItem">
		<div class="listItemText">{{=description}}</div>
		<div class="listItemSubText">{{=content}}</div>
</div>
<div style="clear:both;"></div>
</script>
...
<div id="{{=id}}" class="listItem">
	<a href="{{=linkUrl}}">
		<img class="listItemIcon" src="{{=listItemIconUrl}}" alt="{{=alt}}">
		<div class="listItemText">{{=listItemText}}</div>
		<div class="listItemSubText">{{=listItemSubText}}</div>
	</a>
</div>
<div style="clear:both;"></div>
</script>

<script id="listItemImagesTmpl" type="text/html">
<div id="{{=id}}" class="listItem">
		<div class="listItemText">{{=listItemText}}</div>
		<div class="listItemSubText">{{=listItemSubText}}</div>
		<div>{{=listItemImages}}</div>
</div>
<div style="clear:both;"></div>
</script>

<script id="listItemImageTmpl" type="text/html">
<a rel="lightbox-mygallery" href="{{=src}}" title="title:description" class="lightbox-enabled">
	<img id="{{=id}}" class="listItemImage" src="{{=src}}" alt="{{=alt}}" width="75px"/>
</a>
</script>
