        ...
        <c:when test="<%= formField.isAttributeField() %>">
            <c:choose>
                <c:when test="${ formField.attribute == null }">
                    ...
                    <td>
                    	<span class="table_input_container">
	                        <select class="attrTypeSelect" name="add_typeCode_${index}" onchange="bdrs.attribute.getRowTypeChangedFunc(${index}, true);"
	                        >
                ...
                <c:otherwise>
                    ...
                    <td>
                    	<span class="table_input_container">
	                        <select class="attrTypeSelect" name="typeCode_${formField.attribute.id}" onchange="bdrs.attribute.getRowTypeChangedFunc(${formField.attribute.id}, false);">
